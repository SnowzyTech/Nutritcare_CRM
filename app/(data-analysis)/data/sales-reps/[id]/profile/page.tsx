...
import { ChevronDown, ArrowLeft, History } from "lucide-react";
    ...
    <div className="max-w-[1200px] mx-auto font-inter text-slate-900 pb-20">
      ...
      <div className="bg-white rounded-[32px] p-10 shadow-[0_1px_4px_rgba(0,0,0,0.02)] border border-slate-50 mb-8 relative">
        <div className="flex justify-between items-start">
              ...
              <div className="flex items-center gap-4 mt-1">
                <p className="text-[1.05rem] text-slate-400">
                  ...
                  {rep.team && (
                    <>
                      {" "}
                      <span className="font-bold text-slate-600">{rep.team.name}</span>
                    </>
                  )}
                </p>
                <div
                  className={`flex items-center gap-1.5 border rounded-lg px-2.5 py-0.5 text-[0.7rem] font-black uppercase ${
                    rep.isActive
                ...
                >
                  ...
                  <span
                    className={`w-1.5 h-1.5 rounded-full ${
                      rep.isActive ? "bg-emerald-500" : "bg-slate-300"
                    }`}
                  />
                </div>
              </div>
          ...
          <div className="text-right">
            <p className="text-[0.8rem] text-slate-400 leading-tight">
              Overall performance
              <br />
              <span className="font-bold text-slate-900 text-[1rem]">
        ...
        <div className="grid grid-cols-4 gap-y-12">
          <div>
            <p className="text-[0.7rem] text-slate-400 font-bold uppercase tracking-wider mb-2">
              Phone Number
            </p>
            <p className="text-[1.2rem] font-black text-purple-900 tracking-tight">
              {rep.phone ?? "—"}
            </p>
          </div>
          ...
          <div className="border-l border-slate-100 pl-8 mt-[-20px]">
            <div className="bg-white rounded-3xl p-5 border border-slate-100 shadow-sm">
              <div className="flex justify-between items-center mb-4">
                <span className="text-[0.75rem] font-black text-slate-800">
                  General Performance
                </span>
              ...
              <div className="flex justify-between items-end">
                ...
                <div className="text-right">
                  <span className="text-[0.75rem] font-bold text-slate-500">
                    {orderSummary.delivered}D / {orderSummary.failed}F
                  </span>
