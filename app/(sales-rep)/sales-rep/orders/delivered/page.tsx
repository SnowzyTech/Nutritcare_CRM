...
const deliveredOrders: Order[] = [
  ...
  {
    id: '2',
    email: 'halima.sadiq@gmail.com',
    name: 'Halima Sadiq',
    agent: 'Airway',
    agentLocation: 'Abia State',
    product: 'Shred Belly',
    quantity: 1,
    date: '03-02-2026',
  },
  {
    id: '3',
    email: 'victor.onyekachi@gmail.com',
    name: 'Victor Onyekachi',
    agent: 'Mr. Ola',
...
function StatusIndicator({ status = 'delivered' }: { status?: string }) {
