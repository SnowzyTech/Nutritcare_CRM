...
function StatusIndicator({ status = 'cancelled' }: { status?: string }) {
  ...
  return (
    <div className="bg-white rounded-xl overflow-hidden">
      ...
      <div className="p-6 border-b border-gray-200">
        ...
        {/* Status Badge */}
        <span className="bg-red-400 text-white px-3 py-1 rounded text-xs font-semibold inline-block">
          Cancelled
        </span>
      </div>
