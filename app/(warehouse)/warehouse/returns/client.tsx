      ...
      {isEmpty ? (
        ...
        <div className="flex-1 flex items-center justify-center mt-12">
          <div className="bg-white rounded-2xl shadow-sm p-12 flex flex-col items-center justify-center w-[500px] h-[380px]">
            <h2 className="text-[18px] font-semibold text-gray-600 mb-6">Returned Stock</h2>
            ...
            <p className="text-gray-400 text-[12px] mb-5">Create Returned Stock</p>
        ...
        <div className="px-6">
          ...
          <div className="flex items-center gap-3 mb-4 mt-4">
            ...
            <button className="bg-[#059669] hover:bg-[#047857] text-white text-[12px] font-medium px-5 h-[34px] rounded-md transition-colors">
              Go
            </button>
          </div>
              ...
              <table className="w-full text-[11px] border-collapse">
                <thead>
                  <tr className="border-b border-gray-200 text-gray-400 text-left bg-white">
                    ...
                    <th className="px-3 py-3 font-normal uppercase tracking-wider border-r border-gray-100">Agent/Warehouse</th>
                    <th className="px-3 py-3 font-normal uppercase tracking-wider border-r border-gray-100">Qty Returned</th>
                    <th className="px-3 py-3 font-normal uppercase tracking-wider border-r border-gray-100">Damaged</th>
                    <th className="px-3 py-3 font-normal uppercase tracking-wider border-r border-gray-100">Remarks</th>
                ...
                <tbody>
                  {filteredItems.map((item) => (
                    <tr
                      key={item.id}
                      onClick={() => router.push(`/warehouse/returns/${item.id}`)}
