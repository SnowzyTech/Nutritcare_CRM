  ...
  return (
    <div className="max-w-6xl mx-auto flex flex-col gap-6 relative">
      ...
      {filteredOrders.length === 0 ? (
        <div className="bg-white rounded-2xl border border-gray-100 py-20 text-center text-gray-400 text-sm mb-24">No orders found.</div>
      ) : (
        <>
          {/* ── Mobile Card List (visible on small screens) ── */}
          <div className="flex flex-col gap-3 md:hidden mb-24">
          ...
          <div className="hidden md:block bg-[#FAFAFA] rounded-2xl border border-gray-100 overflow-x-auto mb-24">
