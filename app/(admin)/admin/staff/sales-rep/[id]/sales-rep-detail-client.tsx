...
export default function SalesRepDetailClient({ staffName, staffId }: Props) {
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-[32px] shadow-2xl w-full max-w-[450px] p-8 animate-in fade-in zoom-in duration-300">
            ...
            <p className="text-slate-500 text-[0.95rem] leading-relaxed mb-8">
              Are you sure you want to {isDeleteModalOpen ? "permanently delete" : "temporarily suspend"} this account? This action will {isDeleteModalOpen ? "remove all data" : "restrict access"} for <span className="font-bold text-slate-700">{staffName}</span>.
            </p>
