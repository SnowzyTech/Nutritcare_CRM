  ...
  return (
    <div style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
      <div style={{ marginBottom: "1.5rem" }}>
        <h2 style={{ fontSize: "1.2rem", fontWeight: 700, color: "#111", margin: 0 }}>Settings</h2>
        <p style={{ color: "#6b7280", fontSize: "0.875rem", marginTop: 4 }}>Configure your account and system preferences.</p>
      </div>
