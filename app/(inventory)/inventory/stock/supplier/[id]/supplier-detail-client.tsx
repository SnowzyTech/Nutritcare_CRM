          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <p className="text-white/60 text-sm mt-1">Supplier Type: Primary</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <button
                onClick={() => router.push(`/inventory/stock/supplier/${supplier.id}/edit`)}
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex flex-col py-3 border-b border-gray-50">
                    <span className="text-gray-500 text-xs uppercase mb-1">Phone 1</span>
                    <span className="text-gray-900 font-semibold">{supplier.phone1 || "—"}</span>
                  </div>
                  <div className="flex flex-col py-3 border-b border-gray-50">
                    <span className="text-gray-500 text-xs uppercase mb-1">Phone 2</span>
                    <span className="text-gray-900 font-semibold">{supplier.phone2 || "—"}</span>
                  </div>
                </div>
              </div>
            </div>
               ...
               <div>
                ...
                <div className="space-y-4">
                  <div className="flex flex-col py-3 border-b border-gray-50">
                    ...
                    <span className="text-gray-900 font-semibold">{supplier.state || "—"}</span>
                  </div>
                  <div className="flex flex-col py-3 border-b border-gray-50">
                    <span className="text-gray-500 text-xs uppercase mb-1">Full Address</span>
                    <span className="text-gray-900 font-semibold leading-relaxed">{supplier.address || "—"}</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      {showConfirm && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl">
            <h2 className="text-xl font-bold text-gray-900 mb-2">Delete Supplier?</h2>
