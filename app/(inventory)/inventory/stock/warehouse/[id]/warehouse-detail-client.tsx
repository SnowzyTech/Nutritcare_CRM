          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <p className="text-white/60 text-sm mt-1">Ref: {warehouse.referenceCode || "—"}</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <button
                onClick={() => router.push(`/inventory/stock/warehouse/${warehouse.id}/edit`)}
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3 py-3 border-b border-gray-50">
                    ...
                    <span className="text-gray-900 font-semibold">{warehouse.phone || "—"}</span>
                  </div>
                  <div className="flex items-center gap-3 py-3 border-b border-gray-50">
                    <Mail className="w-4 h-4 text-[#9D00FF]" />
                    <span className="text-gray-900 font-semibold">{warehouse.email || "—"}</span>
                  </div>
                  <div className="flex items-center gap-3 py-3 border-b border-gray-50">
                    <MapPin className="w-4 h-4 text-[#9D00FF]" />
                    <span className="text-gray-900 font-semibold">{warehouse.address || "—"}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-8">
               <div>
                 ...
                 <p className="text-gray-600 leading-relaxed text-sm">
                   {warehouse.additionalInfo || "No additional information provided for this warehouse."}
                 </p>
               </div>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl">
            ...
            <p className="text-gray-500 text-sm mb-8">
              Are you sure you want to delete <span className="font-semibold text-gray-900">"{warehouse.name}"</span>?
            </p>
