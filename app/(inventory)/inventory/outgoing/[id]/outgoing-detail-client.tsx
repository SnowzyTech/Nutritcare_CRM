...
export function OutgoingDetailClient({ record }: { record: OutgoingMovementDetail }) {
  ...
  const handleConfirmReverse = () => {
    ...
    startTransition(async () => {
      ...
      toast.success("Outgoing movement reversed");
  ...
  const handleConfirmDelete = () => {
    ...
    startTransition(async () => {
      ...
      toast.success("Outgoing movement deleted");
            ...
            <div className="p-8">
              <div className="border border-gray-200 rounded-md overflow-hidden mb-6 flex flex-col">
                <div className="flex border-b border-gray-200">
                  <div className="w-1/2 p-3.5 text-sm text-gray-600 border-r border-gray-200">SO-ID:</div>
                  <div className="w-1/2 p-3.5 text-sm text-gray-800">{record.soId}</div>
                </div>
                <div className="flex border-b border-gray-200">
                  <div className="w-1/2 p-3.5 text-sm text-gray-600 border-r border-gray-200">State / Country:</div>
                  <div className="w-1/2 p-3.5 text-sm text-gray-800">{record.state}, {record.country}</div>
                </div>
                <div className="flex border-b border-gray-200">
                ...
                <div className="flex">
                  <div className="w-1/2 p-3.5 text-sm text-gray-600 border-r border-gray-200">Date Sent:</div>
