...
export function AdjustmentDetailClient({ record }: { record: AdjustmentDetail }) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20 backdrop-blur-sm print:hidden">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-lg overflow-hidden">
            <div className="p-8">
              ...
              <p className="text-amber-500 font-semibold mb-6">Do you want to reverse this adjustment?</p>
      ...
      {isDeleteModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20 backdrop-blur-sm print:hidden">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md overflow-hidden">
            <div className="p-8">
              <h2 className="text-lg font-bold text-gray-900 mb-2">Delete Adjustment</h2>
              <p className="text-sm text-gray-600 mb-1">
                Are you sure you want to delete <span className="font-semibold">{record.saId}</span>?
              </p>
